...
@export var base_fgd_files: Array = [] # (Array, Resource)
@export var entity_definitions: Array = [ # (Array, Resource)
	load("res://addons/qodot/game_definitions/fgd/solid_classes/worldspawn_solid_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/solid_classes/group_solid_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/solid_classes/detail_solid_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/solid_classes/illusionary_solid_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/solid_classes/worldspawn_solid_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/base_classes/light_base_class.tres"),
	load("res://addons/qodot/game_definitions/fgd/point_classes/light_point_class.tres"),
]
