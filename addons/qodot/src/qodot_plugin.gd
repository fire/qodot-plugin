...
func _enter_tree() -> void:
	...
	add_custom_type("QodotMap", "Node3D", load("res://addons/qodot/src/nodes/qodot_map.gd"), null)
	add_custom_type("QodotEntity", "Node3D", load("res://addons/qodot/src/nodes/qodot_entity.gd"), null)
	add_custom_type("QodotSpatial", "Node3D", load("res://addons/qodot/src/nodes/qodot_spatial.gd"), null)
